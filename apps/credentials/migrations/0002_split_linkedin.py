...
def rename_linkedin_to_company(apps, schema_editor):
    ...
    PlatformCredential.objects.filter(platform="linkedin").update(platform="linkedin_company")


def rename_company_to_linkedin(apps, schema_editor):
    PlatformCredential = apps.get_model("credentials", "PlatformCredential")
    PlatformCredential.objects.filter(platform="linkedin_company").update(platform="linkedin")
