...
# WAIIS single-tenant fork (Task 12): the client_portal app was removed, so the
# ClientPortalManagerInviteTests class (which exercised
# ``client_portal_admin:invite_client``) is dropped. Recorded in ADR-002.
