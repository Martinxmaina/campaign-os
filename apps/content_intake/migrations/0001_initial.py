    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proof_status', models.CharField(choices=[('confirmed', 'Confirmed'), ('tbd', 'TBD'), ('needs_verification', 'Needs Verification')], default='tbd', max_length=20)),
                ...
                ('channel_targets', models.JSONField(blank=True, default=list)),
                ...
                ('post', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='intake_source', to='composer.post')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.CharField(choices=[('sensitivity_unrecognized', 'Sensitivity Unrecognized'), ('status_unmapped', 'Status Unmapped'), ('channel_unparseable', 'Channel Unparseable'), ('general_parse_failure', 'General Parse Failure')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_conditions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
