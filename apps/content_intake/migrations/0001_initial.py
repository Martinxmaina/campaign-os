# Generated by Django 5.1.15 on 2026-06-10 07:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('angle', models.CharField(blank=True, default='', max_length=255)),
                ...
                ('sensitivity', models.CharField(choices=[('public_safe', 'Public Safe'), ('partner_only', 'Partner Only'), ('private_hold', 'Private Hold'), ('confidential', 'Confidential')], default='private_hold', max_length=20)),
                ...
                ('priority', models.CharField(blank=True, choices=[('H', 'High'), ('M', 'Medium'), ('L', 'Low')], default='', max_length=1)),
                ('status', models.CharField(choices=[('idea', 'Idea'), ('accepted', 'Accepted'), ('drafting', 'Drafting'), ('in_review', 'In Review'), ('approved', 'Approved'), ('scheduled', 'Scheduled'), ('published', 'Published'), ('archived', 'Archived'), ('blocked', 'Blocked'), ('held', 'Held'), ('skipped', 'Skipped'), ('review_queue', 'Review Queue')], default='idea', max_length=20)),
                ...
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_intakes', to=settings.AUTH_USER_MODEL)),
                ('post', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='intake', to='composer.post')),
                ('submitted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='submitted_intakes', to=settings.AUTH_USER_MODEL)),
                ('workspace', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='content_intakes', to='workspaces.workspace')),
            ],
            options={
